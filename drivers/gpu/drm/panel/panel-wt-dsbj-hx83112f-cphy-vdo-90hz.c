...
static int dsbj_unprepare(struct drm_panel *panel)
{
	...
	if (w2_gesture_status == 1) {
		printk("[HXTP]dsbj_unprepare w2_gesture_status = 1\n ");
	} else {
		printk("[HXTP]dsbj_unprepare w2_gesture_status = 0\n ");
...
static const struct drm_display_mode default_mode = {
	...
	.hdisplay = HAC,
	.hsync_start = HAC + HFP,
	.hsync_end = HAC + HFP + HSA_S,
	.htotal = HAC + HFP + HSA_S + HBP_S,
	.vdisplay = VAC,
	.vsync_start = VAC + VFP_60HZ,
	.vsync_end = VAC + VFP_60HZ + VSA_S,
	.vtotal = VAC + VFP_60HZ + VSA_S + VBP_S,
};
...
static const struct drm_display_mode performance_mode = {
	...
	.vsync_end = VAC + VFP_90HZ + VSA_S,
	.vtotal = VAC + VFP_90HZ + VSA_S + VBP_S,
};
...
static int dsbj_get_modes(struct drm_panel *panel, struct drm_connector *connector)
{
