...
static bool pause_mode_flag[HX9023S_CH_NUM] = {false};
...
#else
    hx9023s_pdata.irq_gpio = of_get_named_gpio(dt_node, "tyhx,irq-gpio", 0);
...
static int hx9023s_ch_en(uint8_t ch_id, uint8_t en)
{
    ...
    if(ch_enable_status > 0) {
        ...
        if(1 == en) {
            for(ii = 0; ii < HX9023S_CH_NUM; ii++) {
                if ((hx9023s_pdata.channel_used_flag >> ii) & 0x01) {
...
static ssize_t hx9023s_raw_data_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    char *p = buf;
    int ii = 0;
...
static ssize_t hx9023s_reg_write_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    int ret = -1;
...
static ssize_t hx9023s_reg_read_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    int ret = -1;
    unsigned int reg_address = 0;
    uint8_t addr = 0;
...
static ssize_t hx9023s_channel_en_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    int ch_id = 0;
    int en = 0;
...
static ssize_t hx9023s_channel_en_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    int ii = 0;
    char *p = buf;
...
static ssize_t hx9023s_manual_offset_calibration_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    hx9023s_read_offset_dac();
    return sprintf(buf, "OFFSET_DAC, %-8d, %-8d, %-8d\n", data_offset_dac[0], data_offset_dac[1], data_offset_dac[2]);
}

static ssize_t hx9023s_manual_offset_calibration_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    unsigned long val;
...
static ssize_t hx9023s_prox_state_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
...
static ssize_t hx9023s_polling_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    int value = 0;
    int ret = -1;
...
static ssize_t hx9023s_polling_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
...
static ssize_t hx9023s_loglevel_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    PRINT_INF("tyhx_log_level=%d\n", tyhx_log_level);
    return sprintf(buf, "tyhx_log_level=%d\n", tyhx_log_level);
}

static ssize_t hx9023s_loglevel_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    int ret = -1;
    int value = 0;
...
static ssize_t hx9023s_accuracy_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    PRINT_INF("hx9023s_data_accuracy=%d\n", hx9023s_data_accuracy);
    return sprintf(buf, "hx9023s_data_accuracy=%d\n", hx9023s_data_accuracy);
}

static ssize_t hx9023s_accuracy_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    int ret = -1;
    int value = 0;
...
static ssize_t hx9023s_threshold_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    unsigned int ch = 0;
...
static ssize_t hx9023s_threshold_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    int ii = 0;
    char *p = buf;
...
static ssize_t hx9023s_dump_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    int ret = -1;
    int ii = 0;
    char *p = buf;
...
static ssize_t hx9023s_offset_dac_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    int ii = 0;
    char *p = buf;
    ...
    for (size_t index = 0; index < HX9023S_CH_NUM; index++) {
        if (!strcmp(temp_input_dev->name, hx9023_channels[index].name)) {
            if (0 != hx9023s_ch_en(index, val)) {
                PRINT_ERR("hx9023_ch%zu_en failed\n",  index);
                mutex_unlock(&hx9023s_ch_en_mutex);
                return -1;
            }
...
/* +S96818AA1-6209, liuling3.wt,ADD, 2023/06/08, wt Adaptive sensor new hal */
            ...
            if((hx9023s_pdata.prox_state_reg >> index) & 0x1){
                hx9023_channels[index].state = PROXACTIVE;
                input_report_rel(hx9023s_pdata.chs_info[index].input_dev_abs, REL_MISC, SAR_STATE_NEAR);
                input_report_rel(hx9023s_pdata.chs_info[index].input_dev_abs, REL_X, 2);
            }
            else{
                hx9023_channels[index].state = IDLE;
...
static ssize_t ch1_cap_diff_dump_show(const struct class *class,
                                      const struct class_attribute *attr,
                                      char *buf)
{
...
static void hx9023s_remove(struct i2c_client *client)
{
    ENTER;
