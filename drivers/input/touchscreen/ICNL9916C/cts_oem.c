...
#define OEM_OF_DEF_PROPVAL_TEST_INT_PIN     false   /* S96818AA3-281,caoxin2.wt,modify,2024/9/10,disable int test */
...
/* +S96818AA3-281,caoxin2.wt,modify,2024/9/10,icnl9916_dsbj adjusting openshortTest limits */
#define OEM_OF_DSBJ_PROPVAL_RAWDATA_MIN     1098
#define OEM_OF_DSBJ_PROPVAL_RAWDATA_MAX     3038
#define OEM_OF_DSBJ_PROPVAL_NOISE_MAX        140
/* -S96818AA3-281,caoxin2.wt,modify,2024/9/10,icnl9916_dsbj adjusting openshortTest limits */
...
/* +S96818AA3-281,caoxin2.wt,modify,2024/9/10,add openshort test */
    ...
    struct device_node *np)
{
    ...
    if (oem_data->test_rawdata) {
        ...
        /* +S96818AA3-281,caoxin2.wt,modify,2024/9/10,icnl9916_dsbj adjusting openshortTest limits */
        if (strstr(wt_saved_command_line,"n28_icnl9916c_dsi_vdo_hdp_dsbj_mdt")){
            oem_data->rawdata_min = OEM_OF_DSBJ_PROPVAL_RAWDATA_MIN;
            oem_data->rawdata_max = OEM_OF_DSBJ_PROPVAL_RAWDATA_MAX;
        }
        /* -S96818AA3-281,caoxin2.wt,modify,2024/9/10,icnl9916_dsbj adjusting openshortTest limits */
    }
    ...
    if (oem_data->test_noise) {
        ...
        /* +S96818AA3-281,caoxin2.wt,modify,2024/9/10,icnl9916_dsbj adjusting openshortTest limits */
        if (strstr(wt_saved_command_line,"n28_icnl9916c_dsi_vdo_hdp_dsbj_mdt")){
            oem_data->noise_max = OEM_OF_DSBJ_PROPVAL_NOISE_MAX;
        }
        /* -S96818AA3-281,caoxin2.wt,modify,2024/9/10,icnl9916_dsbj adjusting openshortTest limits */
    }
...
/* +S96818AA3-281,caoxin2.wt,add,2024/9/10,add openshort test */
