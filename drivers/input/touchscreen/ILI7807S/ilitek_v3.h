...
#define DRIVER_VERSION			"3.0.11.0.240703"
...
#define MTK_DISP_SUSPEND_RESUME		ENABLE
...
({									\
	pr_info("touchpanel_tp: (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
})									\

#define ILI_ERR(fmt, arg...)						\
({									\
	pr_err("touchpanel_tp: (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
})									\
