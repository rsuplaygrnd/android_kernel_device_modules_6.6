...
#define FTS_FW_NAME_PREX_WITH_REQUEST_TEM           "focaltech_ft8722_fw_sharp_txd"
...
static int fts_fw_resume(bool need_reset, enum FW_TYPE fw_type)
{
    ...
    if(f_tp_name == 1){
        ...
        snprintf(fwname, FILE_NAME_LENGTH, "%s%s.bin", \
        FTS_FW_NAME_PREX_WITH_REQUEST_TEM, upg->module_info->vendor_name);
    }
