...
struct ovt_tcm_hcd {
	...
	struct workqueue_struct *charger_notify_wq_ovt;
	struct work_struct ovt_resume_work;
#ifdef CONFIG_OVT_CHARGER_DETECT
    struct workqueue_struct *workqueue;
#endif
	struct workqueue_struct *charher_workqueue;
