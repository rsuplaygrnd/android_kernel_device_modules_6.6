...
static void get_fw_ver_bin(void *device_data)
{
	...
	sprintf(buff,"TRULY,NT36528,FW:0x%02x\n", ts->fw_ver);
...
static struct sec_cmd sec_cmds[] = {
	...
	{SEC_CMD("set_earphone_mode", set_earphone_mode),},
	{SEC_CMD("glove_mode", high_sensitivity_mode),},

	{SEC_CMD("aot_enable", aot_enable),},
#if PROXIMITY_FUNCTION
	{SEC_CMD("ear_detect_enable", ear_detect_enable),},
	{SEC_CMD("prox_lp_scan_mode", prox_lp_scan_mode),},
#endif
#if SHOW_NOT_SUPPORT_CMD
	...
	{SEC_CMD("set_untouchable_area_rect", set_untouchable_area_rect),},
