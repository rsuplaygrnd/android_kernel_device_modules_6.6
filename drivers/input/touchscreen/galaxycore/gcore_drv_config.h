...
/* ic type  7371:1  7271:2  7202:3  7302:4  7372:5  7202H:6 7272:7  */  
/*------------------------------------------------------------------*/
#define TOUCH_DRIVER_RELEASE_VERISON   ("1.6.1.3_240722")
...
/*
 * FW_BIN_NAME is used as the fw name required by the request_firmware.
 */
#define FW_BIN_NAME     "gcore_tp_fw_txd.bin"

/*
 * MP_BIN_NAME and MP_TEST_INI is used as the mp ito test.
 */
#if GCORE_MP_TEST_ON
#define MP_BIN_NAME   "GC7202_mp_txd.bin"
#define MP_TEST_INI   "gcore_mp_test_txd.ini"
#endif
