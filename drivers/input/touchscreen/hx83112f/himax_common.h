...
#define HIMAX_DRIVER_VER "2.1.0.23_N22_04"
...
#define HX_PATCH_COMERR_PM                 1
#define HX_TIMEOUT_COMERR_PM               700
...
#define HX_83102P_SERIES_PWON		"HX83102P"
...
/*sunzhenhai.wt,add,2021.11.22,add lcm name;*/
...
int himax_report_data_v2(struct himax_ts_data *ts, int ts_path, int ts_status);
