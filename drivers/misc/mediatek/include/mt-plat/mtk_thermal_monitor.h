...
enum mtk_thermal_sensor_id {
	...
	MTK_THERMAL_SENSOR_MAINBOARD, //S96901AA5-512,songyuanqiao@wingtech.com,modify,20240920,add the thermal NTC;
    MTK_THERMAL_SENSOR_FLASH, //S96901AA5-512,songyuanqiao@wingtech.com,modify,20240920,add the thermal NTC;
