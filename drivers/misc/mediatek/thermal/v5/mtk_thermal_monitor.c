...
static int mtk_thermal_get_tz_idx(char *type)
{
	...
	else if (strncmp(type, "mtktsmainboard", 14) == 0)  //S96901AA5-512,songyuanqiao@wingtech.com,modify,20240920,add the thermal NTC;
		return MTK_THERMAL_SENSOR_MAINBOARD;
	else if (strncmp(type, "mtktsflash", 10) == 0)  //S96901AA5-512,songyuanqiao@wingtech.com,modify,20240920,add the thermal NTC;
		return MTK_THERMAL_SENSOR_FLASH;
...
/* +reqS96902AA5-401 , xiaozheng2.wt, modify, 20241025, modify 5G to 4G reduction policy*/
