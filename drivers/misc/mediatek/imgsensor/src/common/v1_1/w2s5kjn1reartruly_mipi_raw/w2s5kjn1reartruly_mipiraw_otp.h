#ifndef __W2_S5KJN1TRULY_MIPIRAW_OTP__
#define __W2_S5KJN1TRULY_MIPIRAW_OTP__
...
extern kal_uint16 s5ktruly_read_cmos_eeprom_8(kal_uint16 addr);
...
extern void s5kturly_write_cmos_sensor(kal_uint16 addr, kal_uint16 para);
int s5ktruly_init_sensor_cali_info(void);
extern kal_uint16 s5ktruly_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len);
extern void s5k_read_4cell_from_eeprom(char *data, kal_uint16 datasize);
#endif