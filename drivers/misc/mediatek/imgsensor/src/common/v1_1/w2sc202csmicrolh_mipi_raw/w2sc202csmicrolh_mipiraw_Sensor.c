 ...
 * Filename:
 * ---------
 *     w2sc202csmicrolh_mipiraw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "w2sc202csmicrolh_mipiraw_Sensor.h"

#define OTP_PORTING 1

/****************************Modify Following Strings for Debug****************************/
#define PFX "w2sc202csmicrolh_mipi_raw"

#define LOG_1 LOG_INF("W2SC202CSMICROLH,MIPI 1LANE\n")
...
static struct imgsensor_info_struct imgsensor_info = { 
    .sensor_id = W2SC202CSMICROLH_SENSOR_ID,
...
//#ifdef __GAINMAP__
#if 1
#define W2SC202CSMICROLH_SENSOR_GAIN_BASE             1024
#define W2SC202CSMICROLH_SENSOR_GAIN_MAX              65024 //(63.5 * W2SC202CSMICROLH_SENSOR_GAIN_BASE)
#define W2SC202CSMICROLH_SENSOR_GAIN_MAX_VALID_INDEX  6
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	kal_uint16 reg_gain = gain << 4;

	if (reg_gain < W2SC202CSMICROLH_SENSOR_GAIN_BASE)
		reg_gain = W2SC202CSMICROLH_SENSOR_GAIN_BASE;
	else if (reg_gain > W2SC202CSMICROLH_SENSOR_GAIN_MAX)
		reg_gain = W2SC202CSMICROLH_SENSOR_GAIN_MAX;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16 W2SC202CSMICROLH_AGC_Param[W2SC202CSMICROLH_SENSOR_GAIN_MAX_VALID_INDEX][2] = {
		{  1024,  0x00 },
		{  2048,  0x01 },
		{  4096,  0x03 },
		{  8192,  0x07 },
	...
	for (gain_index = W2SC202CSMICROLH_SENSOR_GAIN_MAX_VALID_INDEX - 1; gain_index >= 0; gain_index--)
		if (reg_gain >= W2SC202CSMICROLH_AGC_Param[gain_index][0])
			break;

	write_cmos_sensor(0x3e09, W2SC202CSMICROLH_AGC_Param[gain_index][1]);
	temp_gain = reg_gain * W2SC202CSMICROLH_SENSOR_GAIN_BASE / W2SC202CSMICROLH_AGC_Param[gain_index][0];
...
static struct stCAM_CAL_DATAINFO_STRUCT w2sc202csmicrolh_eeprom_data ={
	.sensorID= W2SC202CSMICROLH_SENSOR_ID,
	.deviceID = 0x10,
	.dataLength = 0x0778,
...
static struct stCAM_CAL_CHECKSUM_STRUCT w2sc202csmicrolh_checksum[6] =
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
...
#if OTP_PORTING
				//+bug767771, liudijin.wt, ADD, 2022/07/06, add eeprom bringup code.
				imgsensor_set_eeprom_data_bywing(&w2sc202csmicrolh_eeprom_data,w2sc202csmicrolh_checksum);
				if((w2sc202csmicrolh_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
					if(w2sc202csmicrolh_eeprom_data.dataBuffer != NULL) {
						kfree(w2sc202csmicrolh_eeprom_data.dataBuffer);
						w2sc202csmicrolh_eeprom_data.dataBuffer = NULL;
					}
					pr_err("cwd w2sc202csmicrolh get eeprom data failed\n");
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					LOG_INF("cwd w2sc202csmicrolh get eeprom data success\n");
				}
				//-bug767771, liudijin.wt, ADD, 2022/07/06, add eeprom bringup code.
#endif
    ...
    if (*sensor_id != imgsensor_info.sensor_id) {
        ...
        pr_err("w2sc202csmicrolh Read id fail,sensor id: 0x%x\n", *sensor_id);
        *sensor_id = 0xFFFFFFFF;
        return ERROR_SENSOR_CONNECT_FAIL;
    }
    return ERROR_NONE;
...
UINT32 W2SC202CSMICROLH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    w2sc202csmicrolh_MIPI_RAW_SensorInit    */
