...
#if OTP_PORTING
				//+bug767771, chenming.wt, ADD, 2022/07/13, add bf2253L otp bringup.
				imgsensor_set_eeprom_data_bywing(&w2bf2253lmicrosj_eeprom_data,w2bf2253lmicrosj_checksum);
				if((w2bf2253lmicrosj_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
