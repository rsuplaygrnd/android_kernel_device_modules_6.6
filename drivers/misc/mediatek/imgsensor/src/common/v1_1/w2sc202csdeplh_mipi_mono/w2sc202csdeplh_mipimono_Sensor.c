 ...
 * Filename:
 * ---------
 *     w2sc202csdeplh_mipiraw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "w2sc202csdeplh_mipimono_Sensor.h"
#define DUALCAMERA_DIFF 1

/****************************Modify Following Strings for Debug****************************/
#define PFX "w2sc202csdeplh_mipi_mono"

#define LOG_1 LOG_INF("W2SC202CSDEPLH,MIPI 1LANE\n")
...
#ifdef DUALCAMERA_DIFF
//+S96901aa5-742,huangmiao.wt,ADD,2024/09/04, distinguish depth camera params for dualcam
...
static struct imgsensor_info_struct imgsensor_info = { 
    .sensor_id = W2SC202CSDEPLH_SENSOR_ID,
...
static void write_shutter(kal_uint16 shutter)
{
    ...
    LOG_INF("frame_length = %d ", imgsensor.frame_length);
...
#define W2SC202CSDEPLH_SENSOR_GAIN_BASE             1024
#define W2SC202CSDEPLH_SENSOR_GAIN_MAX              65024 //(63.5 * W2SC202CSDEPLH_SENSOR_GAIN_BASE)
#define W2SC202CSDEPLH_SENSOR_GAIN_MAX_VALID_INDEX  6
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	kal_uint16 reg_gain = gain << 4;
	if (reg_gain < W2SC202CSDEPLH_SENSOR_GAIN_BASE)
		reg_gain = W2SC202CSDEPLH_SENSOR_GAIN_BASE;
	else if (reg_gain > W2SC202CSDEPLH_SENSOR_GAIN_MAX)
		reg_gain = W2SC202CSDEPLH_SENSOR_GAIN_MAX;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16 W2SC202CSDEPLH_AGC_Param[W2SC202CSDEPLH_SENSOR_GAIN_MAX_VALID_INDEX][2] = {
		{  1024,  0x00 },
		{  2048,  0x01 },
		{  4096,  0x03 },
		{  8192,  0x07 },
	...
	for (gain_index = W2SC202CSDEPLH_SENSOR_GAIN_MAX_VALID_INDEX - 1; gain_index >= 0; gain_index--)
		if (reg_gain >= W2SC202CSDEPLH_AGC_Param[gain_index][0])
			break;
	write_cmos_sensor(0x3e09, W2SC202CSDEPLH_AGC_Param[gain_index][1]);
	temp_gain = reg_gain * W2SC202CSDEPLH_SENSOR_GAIN_BASE / W2SC202CSDEPLH_AGC_Param[gain_index][0];
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 5;
	 LOG_INF("cwd getimgsensorid!!!\n");
    //sensor have two i2c address 0x6c 0x6d & 0x21 0x20, we should detect the module used i2c address
#ifdef DUALCAMERA_DIFF
	//+S96901aa5-742,huangmiao.wt,ADD,2024/09/04, distinguish depth camera params for dualcam
	LOG_INF("cmd getimgsensorid!!!, main_sensor_id:0x%x\n", main_sensor_id);
	//-S96901aa5-742,huangmiao.wt,ADD,2024/09/04, distinguish depth camera params for dualcam
#endif
        ...
        do {
            *sensor_id = return_sensor_id();
            ...
            if ((*sensor_id == imgsensor_info.sensor_id) && (W2S5KJN1REARTRULY_SENSOR_ID == main_sensor_id)){
				LOG_INF("1 supply dualcam(need:w2s5kjn1reartruly_mipi_raw + w2sc202csdeplh_mipi_mono) sensor id match!!");
#else
    ...
    //S96901aa5-742,huangmiao.wt,ADD,2024/09/04, distinguish depth camera params for dualcam
    if ((*sensor_id != imgsensor_info.sensor_id) || (W2S5KJN1REARTRULY_SENSOR_ID != main_sensor_id)) {
		LOG_INF("1 supply dualcam(need:w2s5kjn1reartruly_mipi_raw + w2sc202csdeplh_mipi_mono) sensor id not match!!,main_sensor_id:0x%x,depth sensor id:0x%x\n",main_sensor_id,*sensor_id);
#else
    if (*sensor_id != imgsensor_info.sensor_id) {
#endif
...
UINT32 W2SC202CSDEPLH_MIPI_MONO_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    w2sc202csdeplh_MIPI_RAW_SensorInit    */
