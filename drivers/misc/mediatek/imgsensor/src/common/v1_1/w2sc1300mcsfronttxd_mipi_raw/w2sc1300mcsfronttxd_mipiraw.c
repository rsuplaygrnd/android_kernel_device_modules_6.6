 ...
 * Filename:
 * ---------
 *	 W2SC1300MCSFRONTTXDmipi_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "w2sc1300mcsfronttxd_mipiraw.h"
#include "w2sc1300mcsfronttxd_mipiraw_Sensor_setting.h"
//#include "w2sc1300mcsfronttxd_pdaf_cal.h"
#define PFX "W2SC1300MCSFRONTTXD_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = W2SC1300MCSFRONTTXD_SENSOR_ID,
...
static kal_uint16 sc1300mcs_table_write_cmos_sensor(
...
//+songshiyang.wt, ADD, 2022/02/25, add main camera w2sc1300mcsfronttxd eeprom bring up
#define OTP_PORTING 1

#if OTP_PORTING
#define EEPROM_W2SC1300MCSFRONTTXD_ID 0xA0

#include "cam_cal_define.h"
#include <linux/slab.h>


static struct stCAM_CAL_DATAINFO_STRUCT w2sc1300mcsfronttxd_eeprom_data ={
	.sensorID= W2SC1300MCSFRONTTXD_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x0778,
...
static struct stCAM_CAL_CHECKSUM_STRUCT w2sc1300mcsfronttxd_Checksum[5] =
{
...
static kal_uint16 w2sc1300mcsfronttxd_read_eeprom(kal_uint32 addr)
{
     kal_uint16 get_byte=0;

     char pu_send_cmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };
     iReadRegI2C(pu_send_cmd, 2, (u8*)&get_byte, 1, EEPROM_W2SC1300MCSFRONTTXD_ID);
...
//+songshiyang.wt, ADD, 2022/02/25, add main camera w2sc1300mcsfronttxd eeprom bring up
#if OTP_PORTING
                LOG_INF("w2sc1300mcsfronttxd i2c write id: 0x%x, sensor id: 0x%x module id: 0x%x\n",imgsensor.i2c_write_id, *sensor_id, w2sc1300mcsfronttxd_read_eeprom(0x0001));
				imgsensor_set_eeprom_data_bywing(&w2sc1300mcsfronttxd_eeprom_data,w2sc1300mcsfronttxd_Checksum);
				if((w2sc1300mcsfronttxd_eeprom_data.sensorVendorid >> 24) != w2sc1300mcsfronttxd_read_eeprom(0x0001)) {
					if(w2sc1300mcsfronttxd_eeprom_data.dataBuffer != NULL) {
						kfree(w2sc1300mcsfronttxd_eeprom_data.dataBuffer);
						w2sc1300mcsfronttxd_eeprom_data.dataBuffer = NULL;
					}
					LOG_INF("w2sc1300mcsfronttxd get eeprom data failed\n");
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					LOG_INF("w2sc1300mcsfronttxd get eeprom data success\n");
				}
#endif
//-songshiyang.wt, ADD, 2022/02/25, add main camera w2sc1300mcsfronttxd eeprom bring up
				pr_err("w2sc1300mcsfronttxd i2c write id : 0x%x, sensor id: 0x%x\n",
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		pr_err("w2sc1300mcsfronttxd Read id fail,sensor id: 0x%x\n", *sensor_id);
		*sensor_id = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	return ERROR_NONE;
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sc1300mcs_table_write_cmos_sensor(preview_setting, sizeof(preview_setting) / sizeof(preview_setting[0]));
						  ...
						  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sc1300mcs_table_write_cmos_sensor(capture_setting, sizeof(capture_setting) / sizeof(capture_setting[0]));
	set_mirror_flip(imgsensor.mirror);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sc1300mcs_table_write_cmos_sensor(normal_video_setting, sizeof(normal_video_setting) / sizeof(normal_video_setting[0]));
	set_mirror_flip(imgsensor.mirror);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sc1300mcs_table_write_cmos_sensor(hs_video_setting, sizeof(hs_video_setting) / sizeof(hs_video_setting[0]));
	set_mirror_flip(imgsensor.mirror);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sc1300mcs_table_write_cmos_sensor(slim_video_setting, sizeof(slim_video_setting) / sizeof(slim_video_setting[0]));
	set_mirror_flip(imgsensor.mirror);
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		w2sc1300mcsfronttxd_read_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
		break;
#endif
...
UINT32 W2SC1300MCSFRONTTXD_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
