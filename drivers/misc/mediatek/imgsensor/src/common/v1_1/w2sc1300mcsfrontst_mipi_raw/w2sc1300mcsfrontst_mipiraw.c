...
#include "w2sc1300mcsfrontst_mipiraw_Sensor_setting.h"
...
//+songshiyang.wt, ADD, 2022/02/25, add main camera w2sc1300mcsfrontst eeprom bring up
				...
				imgsensor_set_eeprom_data_bywing(&w2sc1300mcsfrontst_eeprom_data,w2sc1300mcsfrontst_Checksum);
				if((w2sc1300mcsfrontst_eeprom_data.sensorVendorid >> 24) != w2sc1300mcsfrontst_read_eeprom(0x0001)) {
					...
					LOG_INF("w2sc1300mcsfrontst get eeprom data failed\n");
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
