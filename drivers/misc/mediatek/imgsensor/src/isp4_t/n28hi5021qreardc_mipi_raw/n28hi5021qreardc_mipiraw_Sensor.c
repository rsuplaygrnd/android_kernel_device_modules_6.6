...
#include "n28hi5021qreardc_mipiraw_Sensor_setting.h"
...
kal_uint16 skhynix_read_cmos_sensor(kal_uint32 addr)
{
     kal_uint16 get_byte = 0;
     char pu_send_cmd[2] = {(char)(addr >> 8), (char)(addr & 0xFF) };
...
void skhynix_write_cmos_sensor(kal_uint32 addr, kal_uint32 para)
{
     char pu_send_cmd[4] = {(char)(addr >> 8),
         (char)(addr & 0xFF), (char)(para >> 8), (char)(para & 0xFF)};
...
bool skhynix_write_burst_mode(kal_uint16 setting_table[], kal_uint32 nSetSize)
{
