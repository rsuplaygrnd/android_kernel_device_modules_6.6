...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	unsigned short ReadValue0 = read_cmos_sensor(0x3902);
	unsigned short ReadValue1 = read_cmos_sensor(0x3909);
	unsigned short ReadValue2 = read_cmos_sensor(0x390a);
	unsigned short ReadValue3 = read_cmos_sensor(0x5000);
	...
	if (enable)
	{
		...
		write_cmos_sensor(0x5000,0x18);
	}
	else
	{
		write_cmos_sensor(0x3902,ReadValue0);
		write_cmos_sensor(0x3909,ReadValue1);
		write_cmos_sensor(0x390a,ReadValue2);
		write_cmos_sensor(0x5000,ReadValue3);
	} 
	spin_lock(&imgsensor_drv_lock);
