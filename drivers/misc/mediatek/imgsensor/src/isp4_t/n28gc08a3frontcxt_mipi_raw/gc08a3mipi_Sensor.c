...
void write_cmos_sensor_8bit(kal_uint32 addr, kal_uint32 para)
{
	char pu_send_cmd[3] = { 
		(char)((addr >> 8) & 0xff), 
		(char)(addr & 0xff), 
...
static kal_uint32 return_sensor_id(void)
{
	...
	sensor_id = (read_cmos_gc08a3_sensor(0x03f0) << 8) | read_cmos_gc08a3_sensor(0x03f1);
	return sensor_id;
}
...
static void set_dummy(void)
{
	...
	write_cmos_gc08a3_sensor(0x0340, imgsensor.frame_length & 0xfffe);
}
...
static void set_shutter(kal_uint16 shutter)
{
	...
	/* Update Shutter */
	write_cmos_gc08a3_sensor(0x0202, shutter);
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	write_cmos_gc08a3_sensor(0x0204, reg_gain & 0xffff);
	...
	UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_REGISTER:
		sensor_reg_data->RegData = read_cmos_gc08a3_sensor(sensor_reg_data->RegAddr);
