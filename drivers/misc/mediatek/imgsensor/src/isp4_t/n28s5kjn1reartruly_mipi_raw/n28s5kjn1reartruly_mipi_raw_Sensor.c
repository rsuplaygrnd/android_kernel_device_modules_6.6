...
#include "n28s5kjn1reartruly_mipi_raw_Sensor_setting.h"
        ...
        do {
            *sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001));
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                if ((n28s5kjn1reartruly_eeprom_data.sensorVendorid >> 24) != eepromModuleValue) {
                ...
                s5kjn1truly_init_sensor_cali_info();
                return ERROR_NONE;
            }
