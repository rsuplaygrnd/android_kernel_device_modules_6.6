...
#include "n28s5kjn1reardc_mipi_raw_Sensor_setting.h"
#include "n28s5kjn1reardc_mipi_raw_otp.h"

/***************Modify Following Strings for Debug**********************/
#define PFX "n28s5kjn1reardc_camera_sensor"
#define LOG_1 LOG_INF("n28s5kjn1reardc,MIPI 4LANE\n")
/****************************   Modify end    **************************/
#define LOG_INF(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)
#define LOG_ERR(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)

#define DEVICE_VERSION_S5KJN103     "n28s5kjn1reardc"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = N28S5KJN1REARDC_SENSOR_ID,
    .module_id = 0x13,
...
void s5k_write_cmos_sensor(kal_uint16 addr, kal_uint16 para)
{
    char pusendcmd[4] = {(char)(addr >> 8), (char)(addr & 0xFF),
                 (char)(para >> 8), (char)(para & 0xFF)};
    iWriteRegI2C(pusendcmd, 4, imgsensor.i2c_write_id);
...
void s5k_write_cmos_sensor_8(kal_uint16 addr, kal_uint8 para)
{
    char pusendcmd[3] = {(char)(addr >> 8), (char)(addr & 0xFF),
            (char)(para & 0xFF)};
                     ...
                     kal_bool auto_extend_en)
{
    ...
    if (shutter >= 0xFFF0) {
        ...
        LOG_INF("CintR = %llu, Time_Farme = %llu\n", CintR,Time_Farme);
...
static void n28s5kjn1reardc03_set_lsc_reg_setting(
...
kal_uint16 s5k_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
    char puSendCmd[I2C_BUFFER_LEN];
    kal_uint32 tosend, IDX;
    kal_uint16 addr = 0, addr_last = 0, data;
...
static void sensor_init(void)
{
    ...
    table_write_cmos_sensor(n28s5kjn1reardc03_init_setting,
        sizeof(n28s5kjn1reardc03_init_setting) / sizeof(kal_uint16));
...
static void preview_setting(void)
{
    ...
    table_write_cmos_sensor(n28s5kjn1reardc03_preview_setting,
        sizeof(n28s5kjn1reardc03_preview_setting)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    table_write_cmos_sensor(n28s5kjn1reardc03_capture_setting,
        sizeof(n28s5kjn1reardc03_capture_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
    ...
    table_write_cmos_sensor(n28s5kjn1reardc03_normal_video_setting,
        sizeof(n28s5kjn1reardc03_normal_video_setting)/sizeof(kal_uint16));
    LOG_INF("X\n");
}
...
static void hs_video_setting(void)
{
    ...
    table_write_cmos_sensor(n28s5kjn1reardc03_hs_video_setting,
        sizeof(n28s5kjn1reardc03_hs_video_setting)/sizeof(kal_uint16));
    LOG_INF("X\n");
}
...
static void slim_video_setting(void)
{
    ...
    table_write_cmos_sensor(n28s5kjn1reardc03_slim_video_setting,
        sizeof(n28s5kjn1reardc03_slim_video_setting)/sizeof(kal_uint16));
    LOG_INF("X\n");
}
...
static void custom1_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(n28s5kjn1reardc03_custom1_setting,
        sizeof(n28s5kjn1reardc03_custom1_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
...
static void custom2_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(n28s5kjn1reardc03_custom2_setting,
        sizeof(n28s5kjn1reardc03_custom2_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
...
static void custom3_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(n28s5kjn1reardc03_custom3_setting,
        sizeof(n28s5kjn1reardc03_custom3_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
...
static void custom4_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(n28s5kjn1reardc03_custom4_setting,
        sizeof(n28s5kjn1reardc03_custom4_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
        ...
        do {
            *sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001) + 1);
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                eepromModuleValue = n28s5kjn1reardc_read_eeprom(0x0001);
                LOG_INF("s5kjn1_dc eepromModuleValue : 0x%x,", eepromModuleValue);
                if ((n28s5kjn1reardc_eeprom_data.sensorVendorid >> 24) != eepromModuleValue) {
                    *sensor_id = 0xFFFFFFFF;
                    LOG_ERR("read module id not match i2c write id: 0x%x, sensor id: 0x%x module id: 0x%x\n",imgsensor.i2c_write_id, *sensor_id, eepromModuleValue);
                    return ERROR_SENSOR_CONNECT_FAIL;
                }
                s5kjn1dc_init_sensor_cali_info();
                return ERROR_NONE;
            }
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_SET_LSC_TBL:
    {
        ...
        n28s5kjn1reardc03_set_lsc_reg_setting(index, feature_data_16,
