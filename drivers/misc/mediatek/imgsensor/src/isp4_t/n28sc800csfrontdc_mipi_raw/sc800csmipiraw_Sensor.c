...
#define SC800CS_OTP_FUNCTION 1

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N28SC800CSFRONTDC_SENSOR_ID,
...
static kal_uint16 w1sc800cswidely_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_w1sc800cswidely[] = {
	0x0103,0x01,
	0x36e9,0x80,
	0x36f9,0x80,
	0x36eb,0x1c,
...
{
#if MULTI_WRITE
     w1sc800cswidely_table_write_cmos_sensor(
         addr_data_pair_preview_w1sc800cswidely,
         sizeof(addr_data_pair_preview_w1sc800cswidely) /
         sizeof(kal_uint16));
#else
	/*V02P08_20210628*/
	write_cmos_sensor8(0x0103,0x01);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_w1sc800cswidely[] = {
	0x0103,0x01,
	0x36e9,0x80,
	0x36f9,0x80,
	0x36ea,0x11,
...
#if MULTI_WRITE
     w1sc800cswidely_table_write_cmos_sensor(
         addr_data_pair_capture_fps_w1sc800cswidely,
         sizeof(addr_data_pair_capture_fps_w1sc800cswidely) /
         sizeof(kal_uint16));
#else
	/*V02P08_20210628*/
	write_cmos_sensor8(0x0103,0x01);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_w1sc800cswidely[] = {
	0x0103,0x01,
	0x36e9,0x80,
	0x36f9,0x80,
	0x36ea,0x11,
...
#if MULTI_WRITE
     w1sc800cswidely_table_write_cmos_sensor(
         addr_data_pair_normal_video_w1sc800cswidely,
         sizeof(addr_data_pair_normal_video_w1sc800cswidely) /
         sizeof(kal_uint16));
#else
	/*V02P08_20210628*/
	write_cmos_sensor8(0x0103,0x01);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_w1sc800cswidely[] = {
	0x0103,0x01,
	0x36e9,0x80,
	0x36f9,0x80,
	0x36ea,0x1d,
...
#if MULTI_WRITE
     w1sc800cswidely_table_write_cmos_sensor(
         addr_data_pair_hs_video_w1sc800cswidely,
         sizeof(addr_data_pair_hs_video_w1sc800cswidely) /
         sizeof(kal_uint16));
#else
	/*V02P08_20210628*/
	write_cmos_sensor8(0x0103,0x01);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_w1sc800cswidely[] = {
	0x0103,0x01,
	0x36e9,0x80,
	0x36f9,0x80,
	0x36ea,0x11,
...
#if MULTI_WRITE
     w1sc800cswidely_table_write_cmos_sensor(
         addr_data_pair_slim_video_w1sc800cswidely,
         sizeof(addr_data_pair_slim_video_w1sc800cswidely) /
         sizeof(kal_uint16));
#else
	/*V02P08_20210628*/
	write_cmos_sensor8(0x0103,0x01);
...
#if SC800CS_OTP_FUNCTION
//+S96818AA1-1936,zhujianjia.wt,ADD,2023/04/28,sc800cs otp porting
...
static struct stCAM_CAL_DATAINFO_STRUCT n28sc800csfrontdc_eeprom_data ={
    .sensorID= N28SC800CSFRONTDC_SENSOR_ID,
    .deviceID = 0x02,
    .dataLength = 0x0778,
...
static struct stCAM_CAL_CHECKSUM_STRUCT n28sc800csfrontdc_Checksum[MAX_ITEM] =
{
...
#if SC800CS_OTP_FUNCTION
                    //+S96818AA1-1936,zhujianjia.wt,ADD,2023/04/28,sc800cs otp porting
					imgsensor_set_eeprom_data_bywing(&n28sc800csfrontdc_eeprom_data,n28sc800csfrontdc_Checksum);
					if((n28sc800csfrontdc_eeprom_data.sensorVendorid >> 24)!= get_vendor_id()) {
					LOG_INF("get eeprom data failed\n get_vendor_id = 0x%x\n ",get_vendor_id());
					if(n28sc800csfrontdc_eeprom_data.dataBuffer != NULL) {
						kfree(n28sc800csfrontdc_eeprom_data.dataBuffer);
						n28sc800csfrontdc_eeprom_data.dataBuffer = NULL;
						}
						*sensor_id = 0xFFFFFFFF;
						return ERROR_SENSOR_CONNECT_FAIL;
					} else {
						LOG_INF("get eeprom data success\n");
						//imgSensorSetEepromData(&n28sc800csfrontdc_eeprom_data); 
					}
					//-S96818AA1-1936,zhujianjia.wt,ADD,2023/04/28,sc800cs otp porting
#endif
					return ERROR_NONE;
