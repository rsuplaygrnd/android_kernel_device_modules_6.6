...
#define AF_DRVNAME "N28S5KJN1TRULY_GT9778AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long N28S5KJN1TRULY_GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int N28S5KJN1TRULY_GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
     int Ret = 0;
...
int N28S5KJN1TRULY_GT9778AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
             int *pAF_Opened)
{
...
int N28S5KJN1TRULY_GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int N28S5KJN1TRULY_GT9778AF_GetFileName(unsigned char *pFileName)
{
