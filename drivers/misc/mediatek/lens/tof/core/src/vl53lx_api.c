...
static VL53LX_Error SetPresetModeL3CX(struct VL53LX_Dev_t *Dev,
		uint8_t DistanceMode,
		uint32_t inter_measurement_period_ms);

static int IsL4(struct VL53LX_Dev_t *Dev);

static VL53LX_Error CheckValidRectRoi(struct VL53LX_UserRoi_t ROI);


VL53LX_Error VL53LX_GetVersion(struct VL53LX_Version_t *pVersion)
{
...
VL53LX_Error VL53LX_GetProductRevision(struct VL53LX_Dev_t *Dev,
	uint8_t *pProductRevisionMajor, uint8_t *pProductRevisionMinor)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	uint8_t revision_id;
	struct VL53LX_LLDriverData_t   *pLLData;
...
VL53LX_Error VL53LX_GetDeviceInfo(struct VL53LX_Dev_t *Dev,
	struct VL53LX_DeviceInfo_t *pVL53LX_DeviceInfo)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	uint8_t revision_id;
	struct VL53LX_LLDriverData_t   *pLLData;
...
VL53LX_Error VL53LX_GetUID(struct VL53LX_Dev_t *Dev, uint64_t *pUid)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	uint8_t fmtdata[8];
...
VL53LX_Error VL53LX_SetDeviceAddress(struct VL53LX_Dev_t *Dev, uint8_t DeviceAddress)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	struct VL53LX_LLDriverData_t *pdev = VL53LXDevStructGetLLDriverHandle(Dev);
	struct VL53LX_static_nvm_managed_t  *pdata = &(pdev->stat_nvm);
...
VL53LX_Error VL53LX_DataInit(struct VL53LX_Dev_t *Dev)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	struct VL53LX_LLDriverData_t *pdev;
...
EXPORT_SYMBOL(VL53LX_DataInit);

VL53LX_Error VL53LX_WaitDeviceBooted(struct VL53LX_Dev_t *Dev)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
...
EXPORT_SYMBOL(VL53LX_WaitDeviceBooted);
...
VL53LX_Error VL53LX_SetDistanceMode(struct VL53LX_Dev_t *Dev,
		uint8_t DistanceMode)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	uint32_t inter_measurement_period_ms;
...
EXPORT_SYMBOL(VL53LX_SetDistanceMode);

VL53LX_Error VL53LX_GetDistanceMode(struct VL53LX_Dev_t *Dev,
	uint8_t *pDistanceMode)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
...
EXPORT_SYMBOL(VL53LX_GetDistanceMode);

VL53LX_Error VL53LX_SetMeasurementTimingBudgetMicroSeconds(struct VL53LX_Dev_t *Dev,
...
VL53LX_Error VL53LX_GetMeasurementTimingBudgetMicroSeconds(struct VL53LX_Dev_t *Dev,
...
VL53LX_Error VL53LX_SetUserROI(struct VL53LX_Dev_t *Dev,
		struct VL53LX_UserRoi_t *pRoi)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	struct VL53LX_zone_config_t  zone_cfg;
...
VL53LX_Error VL53LX_GetUserROI(struct VL53LX_Dev_t *Dev,
		struct VL53LX_UserRoi_t *pRoi)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	struct VL53LX_zone_config_t zone_cfg;
...
VL53LX_Error VL53LX_StartMeasurement(struct VL53LX_Dev_t *Dev)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
...
EXPORT_SYMBOL(VL53LX_StartMeasurement);

VL53LX_Error VL53LX_StopMeasurement(struct VL53LX_Dev_t *Dev)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
...
EXPORT_SYMBOL(VL53LX_StopMeasurement);

VL53LX_Error VL53LX_ClearInterruptAndStartMeasurement(struct VL53LX_Dev_t *Dev)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	uint8_t DeviceMeasurementMode;
...
EXPORT_SYMBOL(VL53LX_ClearInterruptAndStartMeasurement);

VL53LX_Error VL53LX_GetMeasurementDataReady(struct VL53LX_Dev_t *Dev,
...
EXPORT_SYMBOL(VL53LX_GetMeasurementDataReady);

VL53LX_Error VL53LX_WaitMeasurementDataReady(struct VL53LX_Dev_t *Dev)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
...
EXPORT_SYMBOL(VL53LX_WaitMeasurementDataReady);
...
static VL53LX_Error SetTargetData(struct VL53LX_Dev_t *Dev,
	uint8_t active_results, uint8_t streamcount, uint8_t iteration,
	uint8_t device_status, struct VL53LX_range_data_t *presults_data,
	struct VL53LX_TargetRangeData_t *pRangeData)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	struct VL53LX_LLDriverData_t *pdev =
			VL53LXDevStructGetLLDriverHandle(Dev);
	struct VL53LX_tuning_parm_storage_t *tp =
			&(pdev->tuning_parms);
	uint8_t sequency;
...
static VL53LX_Error SetMeasurementData(struct VL53LX_Dev_t *Dev,
	struct VL53LX_range_results_t *presults,
	struct VL53LX_MultiRangingData_t *pMultiRangingData)
{
	struct VL53LX_LLDriverData_t *pdev = VL53LXDevStructGetLLDriverHandle(Dev);
	uint8_t i;
	uint8_t iteration;
	struct VL53LX_TargetRangeData_t *pRangeData;
	struct VL53LX_range_data_t *presults_data;
	VL53LX_Error Status = VL53LX_ERROR_NONE;
...
VL53LX_Error VL53LX_GetMultiRangingData(struct VL53LX_Dev_t *Dev,
		struct VL53LX_MultiRangingData_t *pMultiRangingData)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	struct VL53LX_LLDriverData_t *pdev =
			VL53LXDevStructGetLLDriverHandle(Dev);
	struct VL53LX_range_results_t *presults =
			(struct VL53LX_range_results_t *) pdev->wArea1;

	LOG_FUNCTION_START("");


	memset(pMultiRangingData, 0xFF,
		sizeof(struct VL53LX_MultiRangingData_t));
...
EXPORT_SYMBOL(VL53LX_GetMultiRangingData);

VL53LX_Error VL53LX_GetAdditionalData(struct VL53LX_Dev_t *Dev,
		struct VL53LX_additional_data_t *pAdditionalData)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
...
VL53LX_Error VL53LX_SetTuningParameter(struct VL53LX_Dev_t *Dev,
...
VL53LX_Error VL53LX_GetTuningParameter(struct VL53LX_Dev_t *Dev,
...
VL53LX_Error VL53LX_PerformRefSpadManagement(struct VL53LX_Dev_t *Dev)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	...
	struct VL53LX_LLDriverData_t *pdev;
	struct VL53LX_customer_nvm_managed_t *pc;
	uint8_t DistanceMode;
...
VL53LX_Error VL53LX_SmudgeCorrectionEnable(struct VL53LX_Dev_t *Dev,
...
VL53LX_Error VL53LX_SetXTalkCompensationEnable(struct VL53LX_Dev_t *Dev,
...
VL53LX_Error VL53LX_GetXTalkCompensationEnable(struct VL53LX_Dev_t *Dev,
...
VL53LX_Error VL53LX_PerformXTalkCalibration(struct VL53LX_Dev_t *Dev)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	VL53LX_Error UStatus;
	int16_t CalDistanceMm;
	struct VL53LX_xtalk_calibration_results_t xtalk;

	struct VL53LX_CalibrationData_t caldata;
	struct VL53LX_LLDriverData_t *pLLData;
	int i;
...
VL53LX_Error VL53LX_SetOffsetCorrectionMode(struct VL53LX_Dev_t *Dev,
...
VL53LX_Error VL53LX_PerformOffsetSimpleCalibration(struct VL53LX_Dev_t *Dev,
	int32_t CalDistanceMilliMeter)
{
	...
	int16_t offset;
	struct VL53LX_MultiRangingData_t RangingMeasurementData;
	struct VL53LX_LLDriverData_t *pdev;
	uint8_t goodmeas;
	VL53LX_Error SmudgeStatus = VL53LX_ERROR_NONE;
	uint8_t smudge_corr_en;
	struct VL53LX_TargetRangeData_t *pRange;
...
VL53LX_Error VL53LX_PerformOffsetZeroDistanceCalibration(struct VL53LX_Dev_t *Dev)
{
...
VL53LX_Error VL53LX_SetCalibrationData(struct VL53LX_Dev_t *Dev,
		struct VL53LX_CalibrationData_t *pCalibrationData)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	struct VL53LX_CustomerNvmManaged_t          *pC;
	struct VL53LX_calibration_data_t            cal_data;
	uint32_t x;
	struct VL53LX_xtalk_calibration_results_t xtalk;
	...
	memcpy(
		...
		sizeof(struct VL53LX_additional_offset_cal_data_t));


	memcpy(
		&(cal_data.optical_centre),
		&(pCalibrationData->optical_centre),
		sizeof(struct VL53LX_optical_centre_t));


	memcpy(
		&(cal_data.xtalkhisto),
		&(pCalibrationData->xtalkhisto),
		sizeof(struct VL53LX_xtalk_histogram_data_t));


	memcpy(
		&(cal_data.gain_cal),
		&(pCalibrationData->gain_cal),
		sizeof(struct VL53LX_gain_calibration_data_t));


	memcpy(
		&(cal_data.cal_peak_rate_map),
		&(pCalibrationData->cal_peak_rate_map),
		sizeof(struct VL53LX_cal_peak_rate_map_t));


	memcpy(
		&(cal_data.per_vcsel_cal_data),
		&(pCalibrationData->per_vcsel_cal_data),
		sizeof(struct VL53LX_per_vcsel_period_offset_cal_data_t));
...
VL53LX_Error VL53LX_GetCalibrationData(struct VL53LX_Dev_t *Dev,
		struct VL53LX_CalibrationData_t  *pCalibrationData)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	struct VL53LX_calibration_data_t      cal_data;
	struct VL53LX_CustomerNvmManaged_t         *pC;
	struct VL53LX_customer_nvm_managed_t       *pC2;
	struct VL53LX_xtalk_calibration_results_t xtalk;
	uint32_t                          tmp;
...
VL53LX_Error VL53LX_PerformOffsetPerVcselCalibration(struct VL53LX_Dev_t *Dev,
	int32_t CalDistanceMilliMeter)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	...
	uint8_t goodmeas;
	uint8_t currentDist;
	uint8_t DistMode[3] = {VL53LX_DISTANCEMODE_SHORT,
...
VL53LX_Error VL53LX_GetOpticalCenter(struct VL53LX_Dev_t *Dev,
		FixPoint1616_t *pOpticalCenterX,
		FixPoint1616_t *pOpticalCenterY)
{
	VL53LX_Error Status = VL53LX_ERROR_NONE;
	struct VL53LX_calibration_data_t  CalibrationData;
