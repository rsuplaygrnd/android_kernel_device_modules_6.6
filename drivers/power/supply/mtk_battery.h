...
#define LOW_TMP_BAT_VOLTAGE_LOW_BOUND 3250 /* ALPS05455882 pre-low tracking properly */
...
#define BATTERY_SHUTDOWN_TEMPERATURE 88
#else
...
#endif
/* UISOC should decrease, when plug in charger but battery keeps drain in HZ mode */
#define PSEUDO1_EN				1
...
#if defined (CONFIG_N28_CHARGER_PRIVATE) || defined (CONFIG_W2_CHARGER_PRIVATE)
#define DISCHARGE_TRACKING_TIME			10 /* ALPS05455856 customize tracking time */
#else
