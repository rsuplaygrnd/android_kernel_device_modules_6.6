...
#if IS_ENABLED(CONFIG_WT_PROJECT_S96901AA1) || IS_ENABLED(CONFIG_WT_PROJECT_S96902AA1) || IS_ENABLED(CONFIG_WT_PROJECT_S96901WA1) || IS_ENABLED(CONFIG_WT_PROJECT_S96818AA1) || IS_ENABLED(CONFIG_WT_PROJECT_S96818BA1)
