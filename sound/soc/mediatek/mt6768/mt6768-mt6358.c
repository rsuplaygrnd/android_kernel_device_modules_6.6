...
/* +Req S96818AA1-1936 dailei.wt 20240817 fs1512 audio bringup */
// FourSemi Add for FS150X start
#include "fs150x.h"
// FourSemi Add for FS150X end
/* -Req S96818AA1-1936 dailei.wt 20240817 fs1512 audio bringup */
...
SND_SOC_DAILINK_DEFS(hostless_fm_record,
	DAILINK_COMP_ARRAY(COMP_CPU("Hostless FM RECORD DAI")),
	DAILINK_COMP_ARRAY(COMP_DUMMY()),
	DAILINK_COMP_ARRAY(COMP_EMPTY()));
...
/* +Req S96818AA1-1936,dailei.wt,20240817, fs1512 pa audio bringup */
// FourSemi Add for FS150X start
	ret = fs150x_audio_amp_init(card);
	if (ret)
		pr_err("fs150x: Failed to init device(%d)\n", ret);
/* -Req S96818AA1-1936,dailei.wt,20240817, fs1512 pa audio bringup */
	return ret;
}
