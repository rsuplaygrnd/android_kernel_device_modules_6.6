...
//+S96901AA5-563, wangdawen.wt, add, 2024/08/14, audio bringup
#if IS_ENABLED(CONFIG_SND_SOC_FS1815N)
...
extern int mt6833_afe_gpio_hac_Select(int mode);
/* -S96901AA5-740, wangdawen.wt, add, 2024/09/10, add HAC func */
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	dev_info(priv->dev, "%s(), get gpio_hac_status %lu\n", __func__, ucontrol->value.integer.value[0]);
	return 0;
}
...
static const struct snd_kcontrol_new mt6359_snd_controls[] = {
	...
	SOC_SINGLE_EXT_TLV("PGA3 Volume",
			   ...
			   snd_soc_get_volsw, mt6359_put_volsw, capture_tlv),
	/* S96901AA5-740, wangdawen.wt, add, 2024/09/10, add HAC func */
	MT_SOC_ENUM_EXT_ID("Aw8155_Hac_Switch", dl_pga_enum[0],
